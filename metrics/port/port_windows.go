...
func (m *MibTCPRow2) SockState() SocketState { return SocketState(m.State) }
...
func (m *MibTCP6Row2) SockState() SocketState { return SocketState(m.State) }
...
func (m *MibUDPRowOwnerPID) SockState() SocketState { return Close }
...
func (m *MibUDP6RowOwnerPID) SockState() SocketState { return Close }
